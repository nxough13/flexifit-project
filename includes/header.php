...
if (isset($_SESSION['user_id'])) {
    ...
    if ($user) {
        ...
        $homeLink = ($userType === 'admin') ? "index.php" : "index.php";
    }
}
?>
    ...
    <nav>
        <ul style="list-style: none; display: flex; gap: 20px; margin: 0; padding: 0;">
            ...
            <?php if ($user && ($user['user_type'] === 'member')): ?>
                ...
                <li style="display: inline;">
                    <a href="/flexifit-project/member/edit-schedule.php" style="text-decoration: none; color: white; font-weight: bold;">View Schedules</a>
                </li>
            <?php elseif ($user && ($user['user_type'] === 'admin')): ?>
                ...
                <li style="display: inline;">
                    <a href="/flexifit-project/admin/view-schedules.php" style="text-decoration: none; color: white; font-weight: bold;">Schedules</a>
                </li>
            <?php endif; ?>
        </ul>
    </nav>
