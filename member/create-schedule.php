...
<head>
    ...
    <style>
        ...
        .error-message { color: red; background-color: #f8d7da; border: 1px solid #f5c6cb; padding: 10px; margin-bottom: 15px; border-radius: 5px; display: none; }
        ...
        #equipment-container { margin-bottom: 15px; }
        #add-equipment { background-color: #fcd100; color: black; padding: 15px; font-weight: bold; width: 100%; cursor: pointer; }
        #add-equipment:hover { background-color: #e0a800; }
        h2 { text-align: center; font-size: 24px; margin-bottom: 20px; color: #FFC107; }
    </style>
</head>
<body>
<div class="container">
...
$(document).ready(function() {
    ...
    $("#add-equipment").click(function() {
        let newBox = `<div class="equipment-box">
            <label>Equipment:</label>
            <select name="equipment[]" class="equipment-select">
                <option value="">Select Equipment</option>
                ${equipmentOptions}
    ...
    $("#submit-schedule").click(function () {
        ...
        $.post("submit_schedule.php", JSON.stringify({ schedule_date: scheduleDate, equipment: equipmentData, trainer_id: selectedTrainer }), function(response) {
